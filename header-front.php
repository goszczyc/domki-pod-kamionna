...
<body <?php body_class(); ?>>
  ...
  <header class="header header--front container container--full-hd">
    <?php if ($logo = get_field('logo', 'options')) : ?>

      <a href="<?= home_url(); ?>" class="header__logo"><?= wp_get_attachment_image($logo, 'full'); ?></a>
          ...
          <div class="header__social">
            ...
            ?>
                ...
                <a href="<?= $social_url; ?>" class="header__social-link">
                  <?= wp_get_attachment_image($social_icon, 'full', '', ['class' => 'header__social-icon']); ?>
                </a>
